...
- Toolbar icon redrawn as a large orange bulb without a background box, so it fills the toolbar cell like other extensions; the status dot keeps its colours.
